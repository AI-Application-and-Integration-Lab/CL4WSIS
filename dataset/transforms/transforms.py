...
class Compose(object):
    ...
    def __call__(self, image, seg_map, peak=None):
        if peak is not None:
...
class RandomScale(object):
    ...
    def __call__(self, image, seg_map, peak=None):
        ...
        if peak is not None:
            ...
            return image.astype(image_dtype), seg_map.astype(seg_map_dtype)
...
class PhotometricDistort(object):
    ...
    def __call__(self, image, seg_map, peak=None):
        ...
        if peak is not None:
            ...
            im, seg_map = self.rand_brightness(im, seg_map)
...
class Keepsize(object):
    ...
    def __call__(self, img, seg_map, peak=None):
        """
        Args:
